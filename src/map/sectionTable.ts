...
export const SECTION_TABLE: SectionMapping[] = [
  ...
  { legacyType: 'grid-playlist', level: 'block', template: null, rootKind: 'content-card', approximated: false, reviewed: 'no', reviewer: '', notes: 'one tile for the playlist: content-card bound to the playlist without repeat, so V3 shows its title, cover and link (also the block type inside legacy scroll sections)' },
  { legacyType: 'carousel-playlist', level: 'block', template: null, rootKind: 'content-card', approximated: false, reviewed: 'no', reviewer: '', notes: 'legacy Carousel.vue lists the playlist files: content-card bound to the playlist, repeated' },
  { legacyType: 'content-grid-playlist', level: 'block', template: null, rootKind: 'content-card', approximated: false, reviewed: 'no', reviewer: '', notes: 'one tile for the playlist: content-card bound to the playlist without repeat' },
  { legacyType: 'search-playlist', level: 'block', template: null, rootKind: 'content-card', approximated: false, reviewed: 'no', reviewer: '', notes: 'legacy Search.vue lists results from the playlist: content-card bound to the playlist, repeated' },
